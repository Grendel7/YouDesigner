<ul class="nav-left">
    ...
    <li>
        <a title="Accounts" class="icon-1" href="/accounts">Accounts</a>
        <ul>
            <li>
    ...
    <li>
        <a title="Emails" class="icon-2" href="/emails">Emails</a>
        <ul>
            <li>
                <a title="Email Accounts" class="visibility-on" href="/emails/manage">Email Accounts</a>
            </li>
            <li>
                <a title="Email Forwarders" class="visibility-on" href="/emails/forwarders">Email Forwarders</a>
            </li>
            <li>
            ...
            <li>
                <a title="Advanced Mail Settings" class="visibility-on" href="/emails/mail-service-control">Advanced Mail Settings</a>
            </li>
            <li>
    ...
    <li>
        <a title="Domains" class="icon-3" href="/domains">Domains</a>
        <ul>
            <li>
            ...
            <li>
                <a title="Addon Domains" class="visibility-on" href="/domains/addon">Addon Domains</a>
            </li>
            <li>
    ...
    <li>
        <a title="Website" class="icon-4" href="/website">Website</a>
        <ul>
            <li>
            ...
            <li>
                <a title="YouBuilder" class="visibility-on" href="/website/builder" target="_blank">YouBuilder</a>
            </li>
            <li>
                <a title="Auto Installer" class="visibility-on" href="/website/auto-installer">Auto Installer</a>
            </li>
            <li>
            ...
            <li>
                <a title="Analyze Website" class="visibility-on" href="http://www.1pagerank.com/example.com" target="_blank">Analyze Website</a>
            </li>
        </ul>
    </li>
    <li>
        <a title="Files" class="icon-5" href="/files">Files</a>
        <ul>
            <li>
                <a title="FTP Access" class="visibility-on" href="/files/ftp-access">FTP Access</a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a title="DNS Manager" class="visibility-on" href="/advanced/dns-zone-editor">DNS Manager</a>
            </li>
            <li>
                <a title="PHP Info" class="visibility-on" href="/advanced/phpinfo">PHP Info</a>
            </li>
            <li>
                <a title="PHP Configuration" class="visibility-on" href="/advanced/php-configuration">PHP Configuration</a>
            </li>
        </ul>
    </li>
    <li>
        ...
        <ul>
            ...
            <li>
                <a title="Reload Account" class="visibility-on" href="/other/reload-account">Reload Account</a>
            </li>
        </ul>
    </li>
</ul>
